...
int main()
{
    ...
    std::cout << "--------------------------------------\n";
    std::cout << "Welcome to the game collecting Suzanne\n";
    std::cout << "--------------------------------------\n";
...
void checkCollisions() {
    ...
    for (unsigned int i = 0; i < 10; i++) {
        float dist = glm::length(modelPositions[i]-camera.Position);
        ...
        if (dist <= 0.6) {
            ...
            {
                // on collision enter
                std::cout << "Camera collides with Suzanne [" << i << "]\n";
            ...
            {
                // on collision
                std::cout << "Camera is colliding with Suzanne [" << i << "]\n";
            }
        }            
    }

    if (detectedCollisions == 0 && onCollision) {
        //on collision exit
